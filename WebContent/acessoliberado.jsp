...
<body>
   ...
   <center style="padding-top: 10%;">
	...
	<table>
	 <tr>
	  <td><a href="salvarUsuario?acao=listartodos"><img src="resources/img/iconlogin.png" width="100px" height="100px" /></a></td>
	  <td><a href="salvarProduto?acao=listartodos"><img src="resources/img/iconproduto.png" width="80px" height="80px"/></a></td>
	 </tr>
	 <tr>
	  <td>Cad. Usuário</td>
	  <td>Cad. Produto</td>
